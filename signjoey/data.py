...
def load_data(data_cfg: dict) -> (Dataset, Dataset, Dataset, Vocabulary, Vocabulary):
    ...
    if isinstance(data_cfg["train"], list):
        ...
        pose_feature_size = data_cfg["pose_feature_size"]
...
#         print(features)
    ...
    pose_field = data.Field(
        ...
        include_lengths=True,
        postprocessing=stack_features,
        pad_token=torch.zeros((pose_feature_size,)),
    )
    ...
    train_data = SignTranslationDataset(
        path=train_paths,
        fields=(sequence_field, signer_field, sgn_field, pose_field, gls_field, txt_field),
